...
import { useFileSystemHandlers, useTkdrawApp } from '~hooks';
import { AlignStyle, TKShapeType } from '~types';
...
export function useKeyboardShortcuts(ref: React.RefObject<HTMLDivElement>) {
  ...
  const canHandleEvent = React.useCallback(
    (ignoreMenus = false) => {
      ...
      return (
        elm &&
        (document.activeElement === elm || elm.contains(document.activeElement))
      );
    },
    [ref]
  );
  ...
  //   () => {
  //     if (!canHandleEvent(true)) return;
  //     app.selectTool(TKShapeType.Rectangle);
  //   },
  //   undefined,
  //   [app]
  // );
  ...
  //   () => {
  //     if (!canHandleEvent(true)) return;
  //     app.selectTool(TKShapeType.Ellipse);
  //   },
  //   undefined,
  //   [app]
  // );
  ...
  //     app.selectTool(TKShapeType.Triangle);
  //   },
  //   undefined,
  //   [app]
  // );
  ...
  //   () => {
  //     if (!canHandleEvent(true)) return;
  //     app.selectTool(TKShapeType.Line);
  //   },
  //   undefined,
  //   [app]
  // );
