...
import { ImageShape, TKImageAsset, TKMeta, TKShapeType } from '~types';

type T = ImageShape;
type E = HTMLDivElement;

export class ImageUtil extends TKShapeUtil<T, E> {
  type = TKShapeType.Image as const;
