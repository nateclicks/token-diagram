...
import { TKMeta, TKShapeType, TKVideoAsset, VideoShape } from '~types';

type T = VideoShape;
type E = HTMLDivElement;

export class VideoUtil extends TKShapeUtil<T, E> {
  type = TKShapeType.Video as const;
  canBind = true;
  canEdit = true;
  canClone = true;
      ...
      return (
        <HTMLContainer ref={ref} {...events}>
          ...
          >
            ...
            >
              <source src={(asset as TKVideoAsset).src} />
            </VideoElement>
          </Wrapper>
        </HTMLContainer>
      );
