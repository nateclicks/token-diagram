...
import { DashStyle, TKMeta, TKShape, TKShapeType, TriangleShape } from '~types';
...
export class TriangleUtil extends TKShapeUtil<T, E> {
  ...
  hitTestLineSegment = (shape: T, A: number[], B: number[]): boolean => {
    return intersectLineSegmentPolyline(A, B, this.getPoints(shape))
      .didIntersect;
  };
  ...
  getBindingPoint = <K extends TKShape>(
    ...
    const intersections = Utils.pointsToLineSegments(
      ...
      .map((segment) =>
        intersectRayLineSegment(origin, direction, segment[0], segment[1])
      )
