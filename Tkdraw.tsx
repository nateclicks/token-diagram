...
import { TKStatus, TokenDocument } from '~types';
...
import { TKCallbacks, TkdrawApp } from '~state';
...
export interface TkdrawProps extends TKCallbacks {
  /**
...
export function Tkdraw({
  ...
  return (
    <TkdrawContext.Provider value={app}>
...
const InnerTldraw = React.memo(function InnerTldraw({
  ...
  const hideIndicators =
    (isInSession && state.appState.status !== TKStatus.Brushing) ||
    !isSelecting;
