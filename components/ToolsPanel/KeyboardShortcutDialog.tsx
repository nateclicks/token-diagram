...
export function KeyboardShortcutDialog({
  ...
  const shortcuts = {
    ...
    View: [
      ...
      {
        label: intl.formatMessage({ id: 'preferences.dark.mode' }),
        kbd: '#⇧D',
      },
      {
        label: intl.formatMessage({ id: 'preferences.focus.mode' }),
        kbd: '#.',
      },
      {
        label: intl.formatMessage({ id: 'preferences.show.grid' }),
        kbd: '#⇧G',
      },
    ],
    Transform: [
      ...
      {
        label: `${intl.formatMessage({ id: 'lock' })} / ${intl.formatMessage({
          id: 'unlock',
        })}`,
        kbd: '#⇧L',
      },
      {
        label: `${intl.formatMessage({ id: 'move' })} ${intl.formatMessage({
          id: 'to.front',
        })}`,
        kbd: '⇧]',
      },
  ...
  return (
    <Dialog.Root onOpenChange={onOpenChange}>
      ...
      <Dialog.Trigger asChild>
        <RowButton id="TK-HelpItem-Keyboard" variant="wide">
