...
import { defaultTextStyle, fills, strokes } from '~shapes/shared';
...
const currentStyleSelector = (s: TKSnapshot) => s.appState.currentStyle;
const selectedIdsSelector = (s: TKSnapshot) =>
...
const themeSelector = (s: TKSnapshot) =>
  s.settings.isDarkMode ? 'dark' : 'light';

const keepOpenSelector = (s: TKSnapshot) => s.settings.keepStyleMenuOpen;

const optionsSelector = (s: TKSnapshot) => {
  ...
  switch (activeTool) {
    ...
    case TKShapeType.Text: {
      return 'text';
    }
    case TKShapeType.Rectangle: {
      return 'label';
    }
    ...
    case TKShapeType.Arrow: {
      return 'label';
    }
    case TKShapeType.Line: {
      return 'label';
    }
  }
...
export const StyleMenu = React.memo(function ColorMenu() {
  ...
  return (
    <DropdownMenu.Root
      ...
      modal={false}
    >
      <DropdownMenu.Trigger asChild id="TK-Styles">
      ...
      <DMContent
        ...
        alignOffset={4}
      >
        <StyledRow variant="tall" id="TK-Styles-Color-Container">
          <span>
          ...
          <ColorGrid>
            {Object.keys(strokes.light).map((style: string) => (
              <DropdownMenu.Item
                ...
                asChild
                id={`TK-Styles-Color-Swatch-${style}`}
              >
                <ToolButton
                  variant="icon"
        ...
        <StyledRow id="TK-Styles-Dash-Container">
        ...
        <StyledRow id="TK-Styles-Size-Container">
        ...
        {(options === 'text' || options === 'label') && (
          <>
            <Divider />
            <StyledRow id="TK-Styles-Font-Container">
            ...
            {options === 'text' && (
              <StyledRow id="TK-Styles-Align-Container">
