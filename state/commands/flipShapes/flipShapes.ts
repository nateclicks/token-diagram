...
export function flipShapes(
  ...
  const isSinglySelectedGroup =
    ids.length === 1 && shapes[ids[0]].type === 'group';
        ...
        case FlipType.Horizontal: {
          if (isChildOfGroup && !isSinglySelectedGroup) {
            ...
            return TLDR.getShapeUtil(shape).transform(
              ...
              {
                ...shapeBounds,
                minX: shapeBounds.minX + dx,
                maxX: shapeBounds.maxX + dx,
              },
              {
        ...
        case FlipType.Vertical: {
          if (isChildOfGroup && !isSinglySelectedGroup) {
            ...
            return TLDR.getShapeUtil(shape).transform(
              ...
              {
                ...shapeBounds,
                minY: shapeBounds.minY + dy,
                maxY: shapeBounds.maxY + dy,
              },
              {
                type: TLBoundsCorner.TopLeft,
                scaleX: 1,
