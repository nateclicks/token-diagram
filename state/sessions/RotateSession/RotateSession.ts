...
export class RotateSession extends BaseSession {
  ...
  changes: Record<string, Partial<TKShape>> = {};
  ...
  constructor(app: TkdrawApp) {
    ...
    const initialShapes = TLDR.getSelectedBranchSnapshot(
      app.state,
      currentPageId
  ...
  update = (): TkdrawPatch | undefined => {
    ...
    const shapes: Record<string, Partial<TKShape>> = {};
  ...
  cancel = (): TkdrawPatch | undefined => {
    ...
    const shapes: Record<string, TKShape> = {};
  ...
  complete = (): TkdrawPatch | TkdrawCommand | undefined => {
    ...
    const beforeShapes = {} as Record<string, Partial<TKShape>>;
