...
export const TRANSLATIONS: TKTranslations = [
...
export type TKTranslation = {
  readonly locale: string;
  readonly label: string;
  readonly messages: Partial<typeof main>;
};

export type TKTranslations = TKTranslation[];

export type TKLanguage = TKTranslations[number]['locale'];

export function getTranslation(locale: TKLanguage): TKTranslation {
